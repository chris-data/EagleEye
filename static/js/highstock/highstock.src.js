...
SVGRenderer.prototype = {
	...
	*/
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		// change Custom variable and prevent setting attribute on the group
...
Axis.prototype.getLogTickPositions = function (interval, min, max, minor) {
	var axis = this,
		...
		// use a Custom variable and return the result
		positions = []; 
...
Tooltip.prototype = {
	 ...
	 */
	destroy: function () {
		// Destroy and clear Custom variables
		if (this.label) {
...
Series.prototype.setStackedPoints = function () {
	...
	// loop over the non-null y values and read them into a Custom array
	for (i = 0; i < yDataLength; i++) {
		x = xData[i];
		y = yData[i];
